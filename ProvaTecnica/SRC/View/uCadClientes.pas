...
type
  TfrmCad_Clientes = class(TForm)
    ...
    procedure CKB_SoAtivosClick(Sender: TObject);
  private
...
procedure TfrmCad_Clientes.PreencheDataSetClienteSoAtivos;
begin
  try
    TB_Clientes.close;
    TB_TelefoneCLI.Close;
    TB_EnderecoCLI.Close;
    Cliente:= TClienteControl.Create;
    DSP_Clientes.DataSet := Cliente.ObterSoAtivos;
    TB_Clientes.Open;
    PreencheDataSetClienteTelefone(TB_ClientesCODIGO.AsInteger);
    PreencheDataSetClienteEndereco(TB_ClientesCODIGO.AsInteger);
  finally
...
procedure TfrmCad_Clientes.CKB_SoAtivosClick(Sender: TObject);
begin
  if CKB_SoAtivos.Checked then
    PreencheDataSetClienteSoAtivos
  else
    PreencheDataSetCliente;
end;
