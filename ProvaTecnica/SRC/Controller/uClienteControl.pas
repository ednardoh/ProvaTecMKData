...
function TClienteControl.ObterPorCPFCNPJ(AValor: string): TFDQuery;
begin
  Result := FClienteModel.ObterPorCPFCNPJ(AValor);
end;

function TClienteControl.ObterSoAtivos: TFDQuery;
begin
  Result := FClienteModel.ObterSoAtivos;
end;
